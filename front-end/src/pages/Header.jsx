  ...
  return (
    <div className="navbar bg-gray-950 h-20 mx-auto flex items-center justify-between">  
      {user ? (
        <div className="dropdown dropdown-end">
          <div className='flex items-center'>
            ...
            <ul tabIndex={0} className="mt-3 z-[1] p-2 shadow menu menu-sm dropdown-content bg-base-100 rounded-box w-52 absolute bottom-0 left-0 top-full">
              {userMenu.map(el => (
                <li key={el.to}>
      ...
      <div className="flex items-center justify-center">
        <Link to='/add-car' className="btn bg-white shadow-md hover:bg-gray-400 pl-2 ml-3 mt-2 w-64 h-10">เพิ่มข้อมูลรถยนต์</Link>
      </div>
    </div>
  );
}
